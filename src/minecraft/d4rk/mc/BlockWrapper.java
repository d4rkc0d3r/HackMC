...
public class BlockWrapper
{
    ...
    public BlockWrapper getRelative(int side, int n)
    {
        switch (side)
        {
            ...
            case POSX:
                return this.getRelative(-n, 0, 0);

            case NEGX:
                return this.getRelative(n, 0, 0);

            default:
                return this.getRelative(0, 0, 0);
        }
    }
    ...
    {
        if (this.getRelative(1, 0, 0).getID() == id)
        {
            return true;
        }

        if (this.getRelative(0, 1, 0).getID() == id)
        {
            return true;
        }

        if (this.getRelative(0, 0, 1).getID() == id)
        {
            return true;
        }
    ...
    public boolean isTouching(int[] id)
    {
        if (this.getRelative(1, 0, 0).isOneOf(id))
        {
            return true;
        }

        if (this.getRelative(0, 1, 0).isOneOf(id))
        {
            return true;
        }

        if (this.getRelative(0, 0, 1).isOneOf(id))
        {
            return true;
        }
    ...
    {
        if (this.getRelative(1, 0, 0).equals(id, metaData))
        {
            return true;
        }

        if (this.getRelative(0, 1, 0).equals(id, metaData))
        {
            return true;
        }

        if (this.getRelative(0, 0, 1).equals(id, metaData))
        {
            return true;
        }
    ...
    {
        if (this.getRelative(1, 0, 0).getMaterial().isLiquid())
        {
            return true;
        }

        if (this.getRelative(0, 1, 0).getMaterial().isLiquid())
        {
            return true;
        }

        if (this.getRelative(0, 0, 1).getMaterial().isLiquid())
        {
            return true;
        }
    ...
    public static BlockWrapper getNearest(Vec3D pos, BlockWrapper[] array, int[] blockIDs, boolean isIgnoreList)
    {
        ...
        {
            if (isIgnoreList == contains(blockIDs, b.getID()))
            {
                continue;
            }
    ...
    {
        for (int candidate : array) if (candidate == reference)
            {
                return true;
            }
