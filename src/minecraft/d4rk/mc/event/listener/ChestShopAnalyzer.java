...
public class ChestShopAnalyzer extends GuiScreen implements EventListener
{
    private HashSet<ChestShop> shopList = new HashSet<ChestShop>();
    ...
    public void initGui()
    {
        isGuiVisible = true;
        buttonList.clear();
        buttonList.add(new GuiButton(-10, -10, 0, "Test"));
    }
    ...
    public void drawScreen(int par1, int par2, float par3)
    {
        ...
        this.drawCenteredString(this.fontRenderer, "Shop Gui", this.width / 2, 40, 16777215);
        GL11.glPushMatrix();
        GL11.glPopMatrix();
