...
public class GuiEditSign extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        this.field_100001_o = new GuiButton(0, this.width / 2 - 100, this.height / 4 + 115, "Done");
        this.buttonList.add(field_100001_o);
        this.buttonList.add(new GuiButton(1, this.width / 2 - 100, this.height / 4 + 140, "Clear"));
        this.entitySign.signText = ItemSign.lastText;
    ...
    protected void actionPerformed(GuiButton par1GuiButton)
    {
        if (par1GuiButton.enabled)
        {
            ...
            {
                this.entitySign.signText = new String[] {"", "", "", ""};
            }
        }
    }
