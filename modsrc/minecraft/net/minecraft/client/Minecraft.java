    ...
    private void clickMouse(int par1)
    {
        if (par1 != 0 || this.leftClickCounter <= 0)
        {
            ...
            else if (this.objectMouseOver.typeOfHit == EnumMovingObjectType.TILE)
            {
                ...
                if (par1 == 0)
                {
                    if (Hack.onBlockLeftClick(this.objectMouseOver.blockX, this.objectMouseOver.blockY,
                            this.objectMouseOver.blockZ, this.objectMouseOver.sideHit))
                    {
                        return;
                    }
                ...
                {
                    if (Hack.onBlockRightClick(this.objectMouseOver.blockX, this.objectMouseOver.blockY,
                            this.objectMouseOver.blockZ, this.objectMouseOver.sideHit))
                    {
                        return;
                    }
    ...
    public void runTick()
    {
        ...
        if (this.currentScreen == null || this.currentScreen.allowUserInput)
        {
            ...
            while (Keyboard.next())
            {
                ...
                if (Keyboard.getEventKeyState())
                {
                    Hack.onKeyPressed(Keyboard.getEventKey());
